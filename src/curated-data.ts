...
export const DAYS: DayPlan[] = [
  ...
  { day: 9, date: "10/30（五）", title: "格拉納達 → 巴塞隆納", subtitle: "直飛，抵達後不綁定門票", emoji: "flight", highlights: [
    { icon: "hotel", time: "依班機時間", title: "早餐＋Room Mate Leo 退房", description: "先享用已包含的早餐並完成退房，再前往 Granada 機場。" },
    { icon: "flight", time: "建議 10:00–13:00 起飛", title: "Vueling GRX → BCN", description: "航程約1小時30分；預留至少 90 分鐘辦理國內線手續，並依行李需求選擇含托運方案。", duration: "約 1h30m", link: "https://www.vueling.com/en/flights-from-granada-to-barcelona" },
  ...
  ], transport: { mode: "✈️ Vueling", from: "Granada GRX", to: "Barcelona BCN", duration: "約 1h30m", details: "優先 10:00–13:00 直飛並依需求加購托運行李；不要用 Basic 票價估算總成本。" } },
