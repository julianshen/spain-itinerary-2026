...
export const HOTELS: Hotel[] = [
  { name: "Madrid｜Atocha／藝術大道", city: "Madrid（10/22–26）", nights: 4, stars: 0, priceRange: "約 €120–300+／晚", description: "Atocha 對首日抵達及南下 Sevilla 最省力；比賽週末供給風險中等，建議現在先訂可取消房。", highlights: ["供給｜訂房窗口已開放，實際剩餘房數不公開", "首選｜Only YOU Atocha：車站正對面", "實惠｜Hotel Mediodía：位置優先", "備選｜NH Madrid Atocha：連鎖品質穩定"], image: "https://images.unsplash.com/photo-1543783207-ec64e4d95325?w=1000&q=80", bookingLinks: [{ name: "Only YOU Atocha 官網", url: "https://www.onlyyouhotels.com/en/hotels/only-you-hotel-atocha/" }, { name: "Hotel Mediodía 官網", url: "https://www.mediodiahotel.com/en/" }, { name: "NH Madrid Atocha 官網", url: "https://www.nh-hotels.com/en/hotel/nh-madrid-atocha" }, { name: "查 10/22–26 即時房況", url: "https://www.booking.com/searchresults.html?ss=Madrid&checkin=2026-10-22&checkout=2026-10-26&group_adults=2&no_rooms=1&group_children=0" }], note: "假設1房2成人。Atlético主場週末可能推高房價；先訂免費取消，再於球賽定時後微調。" },
