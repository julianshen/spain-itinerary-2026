...
export const HOTELS: Hotel[] = [
  { name: "Madrid｜Atocha／藝術大道", city: "Madrid（10/22–24）", nights: 3, stars: 0, priceRange: "約 €120–300+／晚", description: "首選 Atocha 周邊：抵達與前往 Granada 最省力，步行即可到 Prado、Reina Sofía 與 Retiro。", highlights: ["首選｜Only YOU Hotel Atocha：車站正對面、設計感佳", "實惠｜Hotel Mediodía：位置優先、房間較樸實", "舒適｜NH Madrid Atocha：交通方便、連鎖品質穩定"], image: "https://images.unsplash.com/photo-1543783207-ec64e4d95325?w=1000&q=80", bookingLinks: [{ name: "Only YOU Atocha 官網", url: "https://www.onlyyouhotels.com/en/hotels/only-you-hotel-atocha/" }, { name: "Hotel Mediodía 官網", url: "https://www.mediodiahotel.com/en/" }, { name: "NH Madrid Atocha 官網", url: "https://www.nh-hotels.com/en/hotel/nh-madrid-atocha" }, { name: "比較 Madrid 房價", url: "https://www.booking.com/city/es/madrid.html" }], note: "若價差不大，優先 Only YOU；重視預算則選 Hotel Mediodía。" },
  { name: "Granada｜Centro／大教堂區", city: "Granada（10/25–26）", nights: 2, stars: 0, priceRange: "約 €80–220+／晚", description: "不住 Parador，改住平坦、餐廳密集的 Centro。前往 Albaicín 與 Alhambra 可搭公車或計程車，拖行李也更輕鬆。", highlights: ["首選｜Áurea Catedral：大教堂旁、地點最完整", "實惠｜Room Mate Leo：市中心、逛街吃飯方便", "特色｜Hotel Casa 1800：Plaza Nueva附近、老城氛圍佳"], image: "https://images.unsplash.com/photo-1620677368158-32b1293fac36?w=1000&q=80", bookingLinks: [{ name: "Áurea Catedral 官網", url: "https://www.eurostarshotels.co.uk/aurea-catedral.html" }, { name: "Room Mate Leo 官網", url: "https://room-matehotels.com/en/leo/" }, { name: "Hotel Casa 1800 官網", url: "https://www.hotelcasa1800granada.com/en/" }, { name: "比較 Granada 房價", url: "https://www.booking.com/city/es/granada.html" }], note: "建議優先選可免費取消方案；Alhambra 門票須另外購買。" },
  { name: "Barcelona｜Eixample", city: "Barcelona（10/27–31）", nights: 5, stars: 0, priceRange: "約 €130–320+／晚", description: "連住五晚最重視地點與房間舒適度。Eixample 可步行到高第住宅，也能直達舊城與機場交通。", highlights: ["首選｜Hotel Jazz：近 Plaça Catalunya、交通最全面", "實惠｜Praktik Bakery：Passeig de Gràcia旁、風格輕鬆", "升級｜H10 Metropolitan：Plaça Catalunya旁、有露台與小泳池"], image: "https://images.unsplash.com/photo-1507619579562-f2e10da1ec86?w=1000&q=80", bookingLinks: [{ name: "Hotel Jazz 官網", url: "https://www.hoteljazz.com/en/" }, { name: "Praktik Bakery 官網", url: "https://www.hotelpraktikbakery.com/en/" }, { name: "H10 Metropolitan 官網", url: "https://www.h10hotels.com/en/barcelona-hotels/h10-metropolitan" }, { name: "比較 Barcelona 房價", url: "https://www.booking.com/city/es/barcelona.html" }], note: "五晚總價差異大；先比較含早餐與可取消條件，再決定官網或訂房平台。" },
];
