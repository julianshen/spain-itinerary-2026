...
const PLANS: PlanConfig[] = [
  {
    ...
    videos: CITY_VIDEOS,
    cityInfo: CITY_INFO,
    itineraryTitle: "十一日，四個住宿基地",
    itinerarySubtitle: "Madrid 4晚 → Sevilla 2晚 → Granada 2晚 → Barcelona 2晚",
    transportSummary: [
      "TPE → BCN 18h55m",
      "BCN → Madrid 約 2h40m–3h20m",
      "Madrid → Sevilla 約 2h40m",
      "Sevilla → Granada 約 2h30m",
      "GRX → BCN 飛行約 1h30m",
    ],
    attractionsTitle: "必去景點",
    attractionsSubtitle: "Atlético主場、安達魯西亞王城、Alhambra與聖家堂",
    hotelsTitle: "住宿精選",
    hotelsSubtitle: "四間飯店都連住至少兩晚，附日期查價與供給風險",
    mapTitle: "路線地圖",
    mapSubtitle: "Madrid → Sevilla → Granada → Barcelona，一路南下再飛回Barcelona",
    videosTitle: "出發前先看",
    ...
    checklist: [
      ...
      "普拉多美術館＋馬德里皇宮",
      "Madrid Atocha＋Sevilla Rey Alfonso X＋Granada Room Mate Leo — 已預訂",
    ],
  ...
  },
  {
    ...
    label: "方案四：Málaga 路線",
    days: DAYS_MALAGA,
    hotels: HOTELS_MALAGA,
    attractions: ATTRACTIONS_MALAGA,
    videos: CITY_VIDEOS_MALAGA,
    cityInfo: CITY_INFO_MALAGA,
    itineraryTitle: "十一日，五座城市",
    itinerarySubtitle: "Madrid → Granada → Málaga → Ronda 日歸 → 巴塞隆納",
    transportSummary: [
      "TPE → BCN 18h55m",
      "BCN → Madrid 2h30m",
      "Madrid → Granada 2h30m",
      "Granada → Málaga 租車 1.5h",
      "Málaga → Ronda 租車 1.5h",
      "Málaga → BCN 5h30m",
    ],
    attractionsTitle: "必去景點",
    attractionsSubtitle: "從阿罕布拉到畢卡索，再到 Ronda 懸崖小鎮",
    hotelsTitle: "住宿精選",
    hotelsSubtitle: "Parador de Granada + Málaga 老城區",
    mapTitle: "路線地圖",
    mapSubtitle: "Madrid → Granada → Málaga → Ronda 日歸 → BCN",
    videosTitle: "出發前先看",
    videosSubtitle: "用影片預習五大城市的精華",
    dividers: [
      {
        image: "https://images.unsplash.com/photo-1620677368158-32b1293fac36?w=1920&q=85",
        alt: "Alhambra 格拉納達",
        caption: "格拉納達 · 摩爾王朝的最後詩篇",
      },
      {
