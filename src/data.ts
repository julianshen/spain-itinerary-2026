...
export const DAYS: DayPlan[] = [
  {
    ...
    emoji: "plane",
    highlights: [
      { icon: "plane", time: "00:30", title: "台北出發", description: "搭乘阿聯酋航空 EK387，飛往杜拜轉機", duration: "5h", image: "https://images.unsplash.com/photo-1580674285054-bed31e145f59?w=800&q=80" },
      { icon: "coffee", time: "05:15→08:15", title: "杜拜轉機", description: "杜拜機場 3 小時轉機，逛 Duty Free 或休息", duration: "3h" },
      { icon: "arrival", time: "13:25", title: "抵達巴塞隆納", description: "到 BCN，出關領行李", duration: "~1h" },
      { icon: "train", time: "15:00→17:30", title: "AVE 高鐵到馬德里", description: "從 BCN 搭 AVE 直達 Madrid Puerta de Atocha，每小時都有班次", duration: "2h30m", price: "€40-70", link: "https://www.renfe.com/" },
      { icon: "cityscape", time: "18:00", title: "馬德里夜間散步", description: "Check-in 後沿 Gran Vía → 太陽門廣場（零公里標誌）→ 馬約爾廣場 → Mercado de San Miguel 吃 Tapas", image: "https://images.unsplash.com/photo-1543783207-ec64e4d95325?w=800&q=80" },
    ],
  ...
  },
  {
    ...
    emoji: "plane",
    highlights: [
      { icon: "plane", title: "巴塞隆納 → 杜拜 → 台北", description: "搭阿聯酋航空回程，結束 11 天的西班牙大冒險！🇪🇸 期待下次再來～", image: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80" },
    ],
  },
];
...
export const DAYS_REVERSE: DayPlan[] = [
  {
    ...
    highlights: [
      { icon: "plane", time: "00:30", title: "台北出發", description: "搭乘阿聯酋航空 EK387，飛往杜拜轉機", duration: "5h", image: "https://images.unsplash.com/photo-1580674285054-bed31e145f59?w=800&q=80" },
      { icon: "coffee", time: "05:15→08:15", title: "杜拜轉機", description: "杜拜機場 3 小時轉機，逛 Duty Free 或休息", duration: "3h" },
      { icon: "arrival", time: "13:25", title: "抵達巴塞隆納", description: "到 BCN，直接轉國內航班或高鐵南下", duration: "~1h" },
      { icon: "flight", time: "15:30→17:00", title: "BCN → Sevilla", description: "Vueling 直飛 Sevilla，約 1.5h，傍晚抵達佛朗明哥之都", duration: "1h30m", price: "€25-50", link: "https://www.vueling.com/" },
      { icon: "cityscape", time: "18:00", title: "Sevilla 夜間散步", description: "Check-in 後沿瓜達幾維河散步，看黃金塔夜景，Triana 區吃 Tapas", image: "https://images.unsplash.com/photo-1551189014-fe516aed0e9e?w=800&q=80" },
    ],
...
export const CITY_INFO_REVERSE = [
  { name: "塞維亞", coords: [37.3891, -5.9845] as [number, number], emoji: "dance", desc: "停留 2 天" },
  { name: "格拉納達", coords: [37.1773, -3.5986] as [number, number], emoji: "castle", desc: "停留 2 天" },
  { name: "哥多華", coords: [37.8882, -4.7794] as [number, number], emoji: "mosque", desc: "過路半天" },
  { name: "馬德里", coords: [40.4168, -3.7038] as [number, number], emoji: "crown", desc: "停留 2 天" },
  { name: "巴塞隆納", coords: [41.3874, 2.1686] as [number, number], emoji: "art", desc: "停留 4 天" },
];
...
export const CITY_INFO = [
  { name: "馬德里", coords: [40.4168, -3.7038] as [number, number], emoji: "crown", desc: "停留 3 天" },
  { name: "哥多華", coords: [37.8882, -4.7794] as [number, number], emoji: "mosque", desc: "過路半天" },
  { name: "塞維亞", coords: [37.3891, -5.9845] as [number, number], emoji: "dance", desc: "停留 2 天" },
  { name: "格拉納達", coords: [37.1773, -3.5986] as [number, number], emoji: "castle", desc: "停留 3 天" },
  { name: "巴塞隆納", coords: [41.3874, 2.1686] as [number, number], emoji: "art", desc: "停留 3 天" },
];
...
export const DAYS_MALAGA: DayPlan[] = [
  ...
  },
  {
    ...
    emoji: "castle",
    highlights: [
      { icon: "train", time: "08:00→10:30", title: "AVE 到 Granada", description: "馬德里 Atocha 出發，2.5h 直達 Granada", duration: "2h30m", price: "€40-70" },
      { icon: "hotel", time: "11:00", title: "入住 Parador de Granada", description: "位於 Alhambra 宮殿內的傳奇飯店，前身是 15 世紀修道院，陽台就能看到阿罕布拉花園", image: "https://images.unsplash.com/photo-1620677368158-32b1293fac36?w=800&q=80" },
      { icon: "city", time: "12:00-14:00", title: "Albaicín 阿爾拜辛區午餐", description: "UNESCO 世界遺產的摩爾人舊城區，蜿蜒的白色小巷、磁磚庭院，像走入一千零一夜的世界" },
      { icon: "sunset", time: "14:30-16:00", title: "聖尼古拉斯瞭望台", description: "遠眺 Alhambra 的最佳點！下午光影打在宮殿上超美" },
      { icon: "shrimp", time: "晚上", title: "Granada Tapas 巡禮", description: "Granada 是全西班牙唯一點酒就送 Tapas 的城市！Calle Navas 上每家 bar 都有驚喜" },
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      { icon: "hotel", time: "11:00", title: "入住 Málaga 飯店", description: "建議住在老城區或港口附近，方便步行探索", image: "https://images.unsplash.com/photo-1547793548-7a0e7dfdb24f?w=800&q=80" },
      { icon: "art", time: "12:00-14:00", title: "畢卡索美術館", description: "Málaga 是畢卡索出生地，美術館收藏 200+ 幅作品，從早期到立體派都有", duration: "2h", tip: "門票 €9，週日免費", link: "https://www.museopicassomalaga.org/", image: "https://images.unsplash.com/photo-1547793548-7a0e7dfdb24f?w=800&q=80" },
      { icon: "landmark", time: "14:30-15:30", title: "Málaga 羅馬劇場 + 城堡", description: "西元 1 世紀的羅馬劇場，以及摩爾時期的 Alcazaba 城堡，俯瞰港口", image: "https://images.unsplash.com/photo-1547793548-7a0e7dfdb24f?w=800&q=80" },
      { icon: "beach", time: "16:00-18:00", title: "La Malagueta 海灘", description: "Málaga 市區海灘，地中海陽光、沙灘、海鮮餐廳，放鬆一下", image: "https://images.unsplash.com/photo-1547793548-7a0e7dfdb24f?w=800&q=80" },
  ...
  },
  {
    ...
    emoji: "bridge",
    highlights: [
      { icon: "beach", time: "08:00-09:30", title: "Málaga 海灘晨跑", description: "La Malagueta 海灘晨間散步，地中海晨光超療癒", image: "https://images.unsplash.com/photo-1547793548-7a0e7dfdb24f?w=800&q=80" },
      ...
      { icon: "food", time: "晚上", title: "Málaga 老城區晚餐", description: "Atarazanas 市場附近，傳統 Tapas 酒吧巡禮" },
    ],
...
export const HOTELS_MALAGA: Hotel[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1547793548-7a0e7dfdb24f?w=800&q=80",
    bookingLinks: [
...
export const ATTRACTIONS_MALAGA: Attraction[] = [
  ...
  { name: "伯納烏球場", city: "Madrid", emoji: "soccer", description: "皇家馬德里主場，足球迷的聖地", tips: ["門票 €25-40", "包含獎盃室和球員通道", "比賽日可能不開放參觀"], image: "https://images.unsplash.com/photo-1522778034537-20a2486be803?w=800&q=80", timeNeeded: "2h", ticketLink: "https://www.realmadrid.com/en/visit-the-bernabeu" },
  { name: "阿罕布拉宮 Alhambra", city: "Granada", emoji: "landmark", description: "西班牙最偉大的伊斯蘭建築，摩爾人的最後榮光", tips: ["⚠️ 提前 2 個月預約！", "門票 €19.09", "Nasrid 宮殿有時段限制"], image: "https://images.unsplash.com/photo-1620677368158-32b1293fac36?w=800&q=80", timeNeeded: "4h+", ticketLink: "https://tickets.alhambra-patronato.es/en/" },
  { name: "畢卡索美術館", city: "Málaga", emoji: "art", description: "Málaga 是畢卡索出生地，收藏 200+ 幅作品", tips: ["門票 €9，週日免費", "從早期到立體派都有", "建議 2 小時"], image: "https://images.unsplash.com/photo-1547793548-7a0e7dfdb24f?w=800&q=80", timeNeeded: "2h", ticketLink: "https://www.museopicassomalaga.org/" },
  { name: "Málaga 羅馬劇場", city: "Málaga", emoji: "landmark", description: "西元 1 世紀古羅馬遺跡，免費參觀", tips: ["免費", "旁邊就是 Alcazaba 城堡", "可買聯票"], image: "https://images.unsplash.com/photo-1547793548-7a0e7dfdb24f?w=800&q=80", timeNeeded: "1h", ticketLink: "" },
...
export const CITY_INFO_MALAGA = [
  { name: "馬德里", coords: [40.4168, -3.7038] as [number, number], emoji: "crown", desc: "停留 2 天" },
  { name: "格拉納達", coords: [37.1773, -3.5986] as [number, number], emoji: "castle", desc: "停留 2 天" },
  { name: "Málaga", coords: [36.7213, -4.4214] as [number, number], emoji: "beach", desc: "停留 2 天" },
  { name: "Ronda", coords: [36.7462, -5.1611] as [number, number], emoji: "bridge", desc: "一日遊" },
  { name: "巴塞隆納", coords: [41.3874, 2.1686] as [number, number], emoji: "art", desc: "停留 4 天" },
];
...
export const CITY_INFO_RONDA = [
  { name: "馬德里", coords: [40.4168, -3.7038] as [number, number], emoji: "crown", desc: "停留 3 天" },
  { name: "哥多華", coords: [37.8882, -4.7794] as [number, number], emoji: "mosque", desc: "過路半天" },
  { name: "Ronda", coords: [36.7462, -5.1611] as [number, number], emoji: "bridge", desc: "停留 2 天" },
  { name: "塞維亞", coords: [37.3891, -5.9845] as [number, number], emoji: "dance", desc: "停留 2 天" },
  { name: "格拉納達", coords: [37.1773, -3.5986] as [number, number], emoji: "castle", desc: "停留 2 天" },
  { name: "巴塞隆納", coords: [41.3874, 2.1686] as [number, number], emoji: "art", desc: "停留 3 天" },
];